...
class BaseModelSerializer(serializers.ModelSerializer):
    created_by = LowDetailUserModelSerializer(read_only=True)
    updated_by = LowDetailUserModelSerializer(read_only=True)
    created_at = serializers.DateTimeField(read_only=True)
    updated_at = serializers.DateTimeField(read_only=True)
    state = serializers.IntegerField(read_only=True)
    status = serializers.IntegerField(read_only=True)
    owner_user = HighDetailUserModelSerializer(read_only=True)
    responsible_user = LowDetailUserModelSerializer(read_only=True)
